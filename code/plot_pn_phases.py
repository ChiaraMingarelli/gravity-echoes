...
# 1 kpc fiducial long baseline: tau = L/c, L = 1 kpc, theta = 90 deg.
tau_yr = 1000 * 3.08567758e16 / 2.99792458e8 / (365.25 * 86400)  # 3262 yr
...
phi_3_SO = (5.0 / 2) * binary.beta_so
tau_3_SO = (8.0 / 5) * binary.beta_so
phi_3 = phi_3_mass + phi_3_SO
phi_4 = (15293365.0 / 508032 + 27145.0 * eta / 504
         + 3085.0 * eta ** 2 / 72)
phi_4_SS = -10.0 * binary.sigma_ss
...
N_SO_arr = fd_pf * psi_3_SO * (v_grid**(-2) - v_E**(-2))
