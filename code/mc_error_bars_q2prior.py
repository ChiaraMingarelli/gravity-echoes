...
# Mark 108 Mpc (MASSIVE survey boundary, full-sphere count)
...
plt.savefig(os.path.join(outdir, 'N_PTA_vs_distance.png'),
            bbox_inches='tight', dpi=150)
plt.savefig(os.path.join(outdir, 'N_PTA_vs_distance.pdf'),
            bbox_inches='tight')
