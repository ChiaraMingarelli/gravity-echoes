"""Fig 1 generator for "Multiband Gravity Echoes from Supermassive Black Hole
Binaries" (Zheng, Bécsy, Mingarelli 2026). Interactive Streamlit app for the
multiband GW sensitivity landscape (NG15 CW, IPTA 2050, muAres, LISA, GWB
ceilings, fiducial h_c tracks). Export savefig produces gw_sensitivity.pdf,
shipped to the paper as muAres-PTA.pdf. Public mirror: gravity-echoes repo."""
