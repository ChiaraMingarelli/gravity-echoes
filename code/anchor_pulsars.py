...
# ---- Canonical pulsar distances (importable) ----
# Source: Reardon 2024 timing parallax
J0437_DISTANCE_PC = 156.96  # PSR J0437-4715 timing parallax (Reardon 2024)
...
if __name__ == "__main__":
    ...
    pulsars = [
        ("J0437-4715",  J0437_DISTANCE_PC, 0.11, "timing (Reardon 2024)"),
        ("J0636-3044",  230,    37,   "timing parallax (Shamohammadi+ 2024)"),
